...
agent.load_model("./model_final/pg_TUC_agent_2")
exp_results_filename = "PG_TUC_2"
...
for i in range(0, 10):
    ...
    plt.savefig("./experiment_results/TUC_2/"+"Figure_"+str(i+1)+".png")
...
plt.savefig("./experiment_results/TUC_2/2-class Precision-Recall curve.png")
#plt.show()
...
plt.savefig("./experiment_results/TUC_2/Number of reions analyze per object.png")
#plt.show()
