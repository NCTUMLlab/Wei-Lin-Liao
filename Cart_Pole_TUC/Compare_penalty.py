...
PG_TUC_penalty_5_mean = running_mean(PG_TUC_KL_penalty_5,window_size)
PG_TUC_penalty_20_mean = running_mean(PG_TUC_KL_penalty_20,window_size)
...
plt.plot(EPs_X, PG_TUC_penalty_5_mean , "g",label = "PG + 5", linewidth = linewidth)
plt.plot(EPs_X, PG_TUC_penalty_20_mean, "b",label = "PG + 20", linewidth = linewidth)
